  ...
  return (
    <section id="solutions" className="w-full bg-[var(--bg-primary)] px-[120px] py-[100px] flex flex-col items-center gap-14">
      ...
      <div className="relative w-full h-[560px]">
        ...
        {/* Center orb */}
        <div className="absolute left-1/2 top-[165px] -translate-x-1/2 w-[150px] h-[150px] rounded-full bg-gradient-to-b from-[var(--purple-primary)] to-[var(--purple-dark)] flex items-center justify-center shadow-[0_0_60px_25px_rgba(184,134,248,0.31)]">
        ...
        {/* Card 1 - Left */}
        <div className="absolute left-0 top-[140px] w-[340px] bg-[var(--bg-card)] rounded-2xl p-6 border border-[rgba(184,134,248,0.09)] shadow-[0_0_20px_0_rgba(184,134,248,0.07)]">
        ...
        {/* Card 2 - Right */}
        <div className="absolute right-0 top-[140px] w-[340px] bg-[var(--bg-card)] rounded-2xl p-6 border border-[rgba(184,134,248,0.09)] shadow-[0_0_20px_0_rgba(184,134,248,0.07)]">
          <div className="flex flex-col gap-3">
            <div className="w-11 h-11 rounded-[10px] bg-[rgba(184,134,248,0.08)] flex items-center justify-center">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-[380px] w-[420px] bg-[var(--bg-card)] rounded-2xl p-6 border border-[rgba(184,134,248,0.09)] shadow-[0_0_20px_0_rgba(184,134,248,0.07)]">
          <div className="flex flex-col gap-3">
            <div className="w-11 h-11 rounded-[10px] bg-[rgba(184,134,248,0.08)] flex items-center justify-center">
