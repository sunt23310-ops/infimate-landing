...
export default function CaseStudySection() {
  return (
    <section id="cases" className="w-full bg-[var(--bg-primary)] px-[120px] py-[140px] flex flex-col items-center gap-14">
      ...
      <div className="w-full rounded-[20px] p-[1px] bg-gradient-to-br from-[rgba(184,134,248,0.3)] via-transparent to-[rgba(124,58,237,0.15)] shadow-[0_0_30px_0_rgba(184,134,248,0.1)]">
        <div className="w-full bg-[var(--bg-card)] rounded-[20px] p-12 flex items-center gap-12">
